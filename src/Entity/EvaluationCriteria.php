...
#[ORM\UniqueConstraint(name: 'UQ_EVALUATION_CRITERIA_LABEL', fields: ['label', 'workspace'])]
#[ORM\UniqueConstraint(name: 'UQ_EVALUATION_CRITERIA_CANONICAL_LABEL', fields: ['canonicalLabel', 'workspace'])]
