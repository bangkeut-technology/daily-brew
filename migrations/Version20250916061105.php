 ...
 */
final class Version20250916061105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE daily_brew_attendances (id INT UNSIGNED AUTO_INCREMENT NOT NULL, employee_id INT UNSIGNED NOT NULL, user_id INT UNSIGNED DEFAULT NULL, batch_id INT UNSIGNED DEFAULT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', attendance_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', note LONGTEXT DEFAULT NULL, clock_in DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', clock_out DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', type VARCHAR(255) NOT NULL, leave_type VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_CD680F1CB5B48B91 (public_id), INDEX IDX_CD680F1C8C03F15C (employee_id), INDEX IDX_CD680F1CA76ED395 (user_id), INDEX IDX_CD680F1CF39EBE7A (batch_id), UNIQUE INDEX UNIQ_ATTENDANCE_EMPLOYEE_DATE (employee_id, attendance_date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_brew_employee_evaluations (id INT UNSIGNED AUTO_INCREMENT NOT NULL, employee_id INT UNSIGNED NOT NULL, evaluator_id INT UNSIGNED NOT NULL, template_id INT UNSIGNED DEFAULT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', template_name VARCHAR(255) NOT NULL, evaluated_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', note LONGTEXT DEFAULT NULL, average_score DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_1C4A4D25B5B48B91 (public_id), INDEX IDX_1C4A4D258C03F15C (employee_id), INDEX IDX_1C4A4D2543575BE2 (evaluator_id), INDEX IDX_1C4A4D255DA0FB8 (template_id), UNIQUE INDEX UQ_EMPLOYEE_EVALUATION (evaluated_at, employee_id, template_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_brew_employee_scores (id INT UNSIGNED AUTO_INCREMENT NOT NULL, evaluation_id INT UNSIGNED NOT NULL, criteria_id INT UNSIGNED DEFAULT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', criteria_label VARCHAR(255) NOT NULL, score INT NOT NULL, weight INT NOT NULL, comment LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_4BEC1C03B5B48B91 (public_id), INDEX IDX_4BEC1C03456C5646 (evaluation_id), INDEX IDX_4BEC1C03990BEA15 (criteria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_brew_employees (id INT UNSIGNED AUTO_INCREMENT NOT NULL, store_id INT UNSIGNED DEFAULT NULL, user_id INT UNSIGNED NOT NULL, linked_user_id INT UNSIGNED DEFAULT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, phone_number VARCHAR(20) DEFAULT NULL, dob DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', joined_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_370C3B6FB5B48B91 (public_id), INDEX IDX_370C3B6FB092A811 (store_id), INDEX IDX_370C3B6FA76ED395 (user_id), UNIQUE INDEX UNIQ_370C3B6FCC26EB02 (linked_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE daily_brew_evaluation_criterias (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', label VARCHAR(255) NOT NULL, canonical_label VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, weight INT NOT NULL, UNIQUE INDEX UNIQ_F5194DE7B5B48B91 (public_id), INDEX IDX_F5194DE7A76ED395 (user_id), UNIQUE INDEX UQ_EVALUATION_CRITERIA_LABEL (label, user_id), UNIQUE INDEX UQ_EVALUATION_CRITERIA_CANONICAL_LABEL (canonical_label, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_brew_evaluation_template_criterias (id INT UNSIGNED AUTO_INCREMENT NOT NULL, template_id INT UNSIGNED DEFAULT NULL, criteria_id INT UNSIGNED DEFAULT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', weight INT NOT NULL, UNIQUE INDEX UNIQ_AC46DABBB5B48B91 (public_id), INDEX IDX_AC46DABB5DA0FB8 (template_id), INDEX IDX_AC46DABB990BEA15 (criteria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_brew_evaluation_templates (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', name VARCHAR(255) NOT NULL, canonical_name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1B36534FB5B48B91 (public_id), INDEX IDX_1B36534FA76ED395 (user_id), UNIQUE INDEX UQ_EVALUATION_TEMPLATE_NAME (name, user_id), UNIQUE INDEX UQ_EVALUATION_TEMPLATE_CANONICAL_NAME (canonical_name, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE daily_brew_roles (id INT UNSIGNED AUTO_INCREMENT NOT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', name VARCHAR(100) NOT NULL, canonical_name VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_292E8989B5B48B91 (public_id), UNIQUE INDEX UNQ_ROLE_NAME (name), UNIQUE INDEX UNQ_ROLE_NAME_CANONICAL (canonical_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_brew_settings (id INT UNSIGNED AUTO_INCREMENT NOT NULL, owner_id INT UNSIGNED NOT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', name VARCHAR(255) NOT NULL, value VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_63B03ADAB5B48B91 (public_id), INDEX IDX_63B03ADA7E3C61F9 (owner_id), UNIQUE INDEX UNIQ_SETTING_NAME (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_brew_stores (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED DEFAULT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', name VARCHAR(255) NOT NULL, canonical_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_446B00FCB5B48B91 (public_id), INDEX IDX_446B00FCA76ED395 (user_id), UNIQUE INDEX UNIQ_STORE_NAME (name, user_id), UNIQUE INDEX UNIQ_STORE_CANONICAL_NAME (canonical_name, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_brew_users (id INT UNSIGNED AUTO_INCREMENT NOT NULL, public_id VARCHAR(36) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', secret VARCHAR(225) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, roles JSON NOT NULL, first_name VARCHAR(150) DEFAULT NULL, last_name VARCHAR(150) DEFAULT NULL, dob DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', image_name VARCHAR(255) DEFAULT NULL, file_size INT DEFAULT NULL, original_name VARCHAR(255) DEFAULT NULL, mime_type VARCHAR(255) DEFAULT NULL, dimensions JSON DEFAULT NULL, password VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, locale VARCHAR(5) DEFAULT NULL, UNIQUE INDEX UNIQ_8B9302A7B5B48B91 (public_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL_CANONICAL (email_canonical), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL_SECRET (secret), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE daily_brew_attendances ADD CONSTRAINT FK_CD680F1CA76ED395 FOREIGN KEY (user_id) REFERENCES daily_brew_users (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE daily_brew_settings ADD CONSTRAINT FK_63B03ADA7E3C61F9 FOREIGN KEY (owner_id) REFERENCES daily_brew_users (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE daily_brew_attendances DROP FOREIGN KEY FK_CD680F1CA76ED395');
