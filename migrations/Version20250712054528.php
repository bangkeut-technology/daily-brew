 ...
 */
final class Version20250712054528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evaluation_criteria_evaluation_template_criteria (evaluation_criteria_id INT UNSIGNED NOT NULL, evaluation_template_criteria_id INT UNSIGNED NOT NULL, INDEX IDX_2D260A11CA527E62 (evaluation_criteria_id), INDEX IDX_2D260A1191AD3C5B (evaluation_template_criteria_id), PRIMARY KEY(evaluation_criteria_id, evaluation_template_criteria_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE evaluation_criteria_evaluation_template_criteria ADD CONSTRAINT FK_2D260A11CA527E62 FOREIGN KEY (evaluation_criteria_id) REFERENCES daily_brew_evaluation_criterias (id)');
        $this->addSql('ALTER TABLE evaluation_criteria_evaluation_template_criteria ADD CONSTRAINT FK_2D260A1191AD3C5B FOREIGN KEY (evaluation_template_criteria_id) REFERENCES daily_brew_evaluation_template_criterias (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation_criteria_evaluation_template_criteria DROP FOREIGN KEY FK_2D260A11CA527E62');
        $this->addSql('ALTER TABLE evaluation_criteria_evaluation_template_criteria DROP FOREIGN KEY FK_2D260A1191AD3C5B');
        ...
        $this->addSql('DROP TABLE evaluation_criteria_evaluation_template_criteria');
