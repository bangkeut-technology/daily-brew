 ...
 */
final class Version20250728001553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE daily_brew_attendances (id INT UNSIGNED AUTO_INCREMENT NOT NULL, employee_id INT UNSIGNED NOT NULL, user_id INT UNSIGNED DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', identifier VARCHAR(255) NOT NULL, attendance_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', note LONGTEXT DEFAULT NULL, clock_in DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', clock_out DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(255) NOT NULL, INDEX IDX_CD680F1C8C03F15C (employee_id), INDEX IDX_CD680F1CA76ED395 (user_id), UNIQUE INDEX UNIQ_ATTENDANCE_EMPLOYEE_DATE (employee_id, attendance_date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE daily_brew_evaluation_template_criterias (id INT UNSIGNED AUTO_INCREMENT NOT NULL, template_id INT UNSIGNED DEFAULT NULL, criteria_id INT UNSIGNED DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', identifier VARCHAR(32) NOT NULL, weight INT NOT NULL, INDEX IDX_AC46DABB5DA0FB8 (template_id), INDEX IDX_AC46DABB990BEA15 (criteria_id), UNIQUE INDEX UQ_EVALUATION_TEMPLATE_CRITERIA_IDENTIFIER (identifier), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
