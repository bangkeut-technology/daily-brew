    ...
    <div className="page-enter">
      ...
      {view !== 'log' && (
        <div className="flex flex-wrap gap-x-4 gap-y-2 mb-4 text-[12px] font-medium text-text-secondary">
          ...
          <span className="flex items-center gap-1.5"><span className="inline-block w-5 h-5 rounded bg-amber/15 text-amber text-center leading-5 font-mono text-[11px]">LfE</span> {t('attendance.leftEarly', 'Left early')}</span>
