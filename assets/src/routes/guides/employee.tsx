...
export const Route = createFileRoute('/guides/employee')({
  component: EmployeeGuidePage,
});

function EmployeeGuidePage() {
  const { t } = useTranslation();
  const playbook = usePlaybook('employee');
  return (
    <div className="min-h-screen">
      <PageSeo
        title="Employee guide"
        description="Install DailyBrew, link to your workspace, and scan the QR to clock in. Daily routine for restaurant staff."
        path="/guides/employee"
      />
      <LandingNav />
