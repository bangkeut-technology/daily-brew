            ...
            <section className="mx-auto max-w-5xl px-6 md:px-8 py-10 md:py-14 space-y-6">
                ...
                <CardBlock title="Information we collect">
                    <ul className="list-disc pl-5 space-y-2 text-sm md:text-base">
                        ...
                        <li>
                            <strong>Organization data:</strong> employee profiles (first/last name, optional phone,
                            dates), roles, templates, criteria.
                        </li>
                        <li>
                ...
                <CardBlock title="Data retention">
                    <p className="text-sm md:text-base">
                        We keep account and operational data for as long as your account is active. You can request
                        deletion (see “Your rights”). Backups and logs are retained for a limited period for security
                        and continuity. If you cancel, we may keep a read-only copy for a reasonable time so you can
                        retrieve records.
                    </p>
                </CardBlock>
                ...
                <CardBlock title="International transfers">
                    <p className="text-sm md:text-base">
                        Your data may be stored or processed in data centers outside your country. We use safeguards
                        such as contractual commitments with our processors to protect your information across borders.
                    </p>
                </CardBlock>
                ...
                <CardBlock title="Cookies & analytics">
                    <p className="text-sm md:text-base">
                        We use essential cookies for authentication and security. We may use analytics cookies or
                        similar technologies to understand usage and improve features. You can control non-essential
                        cookies via your browser or in-app settings (if available).
                    </p>
                </CardBlock>

                <CardBlock title="Payments (Pro/Business)">
                    <p className="text-sm md:text-base">
                        Payments are processed by a third-party provider. We don’t store full payment card details on
                        our servers. The payment processor acts as a separate controller or processor under its own
                        privacy policy.
                    </p>
                </CardBlock>
                ...
                <CardBlock title="Team access & roles">
                    <p className="text-sm md:text-base">
                        On paid tiers, you can invite users and assign roles. Your organization admins control who can
                        view or edit attendance, leave, and KPI data. In the free tier (single owner), only the account
                        owner manages data.
                    </p>
                </CardBlock>
                ...
                <CardBlock title="Changes to this policy">
                    <p className="text-sm md:text-base">
                        ...
                        the new date at the top and, if changes are material, notify you through the app or email.
                    </p>
                </CardBlock>
