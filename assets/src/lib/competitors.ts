/**
 * Competitor comparison pages — one entry = one /vs-<name> page rendered by
 * the shared CompetitorView template. Claims are kept factual and based on
 * public product information; framing is fair, not absolute. Mirrors
 * frontend/src/lib/competitors.ts (kept in sync manually until cutover).
 */
...
export const COMPETITORS: Competitor[] = [
  {
    ...
    lede:
      "Jibble is a capable, multi-vertical time tracker that leans on face recognition to stop buddy punching. DailyBrew takes the no-biometric route — binding each punch to a verified device and your shop's network instead.",
    rows: [
      ...
      { dimension: 'Free tier', dailybrew: 'Up to 10 active staff', them: 'Unlimited users (upsells)' },
  ...
  },
  {
    ...
    lede:
      'Homebase is a strong US-focused scheduling and time-clock suite that relies on PINs, GPS, and photo-on-punch. DailyBrew focuses on honest clock-ins through device + network verification — no PINs to share.',
    rows: [
      ...
      { dimension: 'Free tier', dailybrew: 'Up to 10 active staff, any region', them: '1 location, ≤10 staff (US-centric)' },
  ...
  },
  {
    ...
    lede:
      'Connecteam is the closest NFC competitor — a broad deskless-workforce HR platform whose NFC is also in beta. DailyBrew builds device + IP + tag as one café-first experience, without selfie verification.',
    rows: [
  ...
  },
  {
    ...
    lede:
      "Clockify has a famously generous free tier, but its kiosk model leans on a PIN that its own docs suggest sharing with a manager. DailyBrew binds each punch to a verified device, so PIN-sharing simply doesn't work.",
    rows: [
      ...
      { dimension: 'Free tier', dailybrew: 'Up to 10 active staff', them: 'Generous free tier' },
  ...
  },
  {
    ...
    lede:
      'Buddy Punch had the right idea with IP Address Lock, but bolts it onto a generic time clock with face recognition and photo-on-punch. DailyBrew makes device + IP the primary defense — and never photographs your staff.',
    rows: [
      ...
      { dimension: 'Free tier', dailybrew: 'Up to 10 active staff', them: 'No free tier' },
    ],
    summary:
  ...
  },
  {
    ...
    lede:
      '7shifts is a full restaurant scheduling and labor platform with photo + geofenced punching. DailyBrew is a focused, free-to-start time clock that verifies the device and network instead of the face and the GPS.',
    rows: [
