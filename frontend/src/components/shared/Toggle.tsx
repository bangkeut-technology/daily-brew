...
export function Toggle({ id, checked, onChange, disabled }: ToggleProps) {
  return (
    <button
      ...
      className={cn(
        "relative inline-flex h-6 w-11 flex-shrink-0 rounded-full cursor-pointer transition-colors duration-200 ease-in-out border-2",
    ...
    >
      <span
        className={cn(
          "pointer-events-none inline-flex items-center justify-center h-5 w-5 rounded-full bg-white shadow-md transform transition-transform duration-200 ease-in-out",
