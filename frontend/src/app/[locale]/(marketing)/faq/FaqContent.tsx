    ...
    items: [
      {
        ...
        answer:
          'The Free plan includes up to 10 active employees, QR check-in, shift tracking, closure periods, and the attendance dashboard. It is free forever with no time limit.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Espresso costs $19.99 per month, or $199 per year if you choose annual billing. The yearly plan saves you $40.88 compared to paying monthly.',
      },
      {
