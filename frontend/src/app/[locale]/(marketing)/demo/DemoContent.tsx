      ...
      <div className="pt-28 pb-20 px-6 md:px-8 max-w-4xl mx-auto page-enter">
        ...
        <div className="space-y-5 mb-14">
          {accounts.map((account, i) => {
            const highlights = t.raw(`routes.demo.accounts.${account.key}.highlights`) as string[];
            return (
              <motion.div
                key={account.key}
                ...
                <div className="p-6">
                  <div className="flex flex-col md:flex-row md:items-start gap-5">
                    ...
                    <div className="md:w-[240px] flex-shrink-0 space-y-3">
                      ...
                      {/* Plain next/link: /sign-in lives outside the [locale]
                          segment, so a locale-aware Link would 404 on /fr. */}
                      <NextLink
                        href="/sign-in"
                        className={cn(
