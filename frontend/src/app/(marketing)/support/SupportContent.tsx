...
export function SupportContent() {
  ...
  const onSubmit = async (data: FeedbackForm) => {
    try {
      await apiV1Axios.post("/support/feedback", {
        type: data.type,
        name: data.name,
        email: data.email,
    ...
    <div className="page-enter pt-20">
      ...
      <section className="py-20 px-6 md:px-8 max-w-3xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <p className="text-[13px] uppercase tracking-[2px] font-medium text-amber mb-3">Support</p>
        ...
        >
          {submitted ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-[20px] font-semibold text-text-primary font-serif mb-2">Message sent</h3>
              <p className="text-[15px] text-text-secondary mb-6">We&apos;ll get back to you within 24 hours.</p>
              <button
                type="button"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  {feedbackTypes.map((ft) => (
                    ...
                    >
                      <ft.icon
                        size={18}
                        strokeWidth={1.8}
                        className={selectedType === ft.value ? "text-coffee" : ft.color}
                      />
                      {ft.label}
                    </button>
                  ))}
                </div>
                {errors.type && <p className="text-[12px] text-red mt-1">{errors.type.message}</p>}
              </div>
              ...
              <div>
                ...
                />
                {errors.name && <p className="text-[12px] text-red mt-1">{errors.name.message}</p>}
              </div>
              ...
              <div>
                ...
                />
                {errors.email && <p className="text-[12px] text-red mt-1">{errors.email.message}</p>}
              </div>
              ...
              <div>
                ...
                />
                {errors.subject && <p className="text-[12px] text-red mt-1">{errors.subject.message}</p>}
              </div>
              ...
              <div>
                ...
                />
                {errors.message && <p className="text-[12px] text-red mt-1">{errors.message.message}</p>}
              </div>
      ...
      {!faqsLoading && faqs.length > 0 && (
        <section className="py-16 px-6 md:px-8 max-w-3xl mx-auto">
          ...
          >
            {faqs.map((faq, i) => (
              <AccordionItem key={faq.id} question={faq.question} answer={faq.answer} index={i} />
            ))}
          </motion.div>
        </section>
      )}
      ...
      <section className="py-16 px-6 md:px-8 max-w-2xl mx-auto">
        ...
        >
          ...
          <h3 className="text-[20px] font-semibold text-text-primary font-serif mb-2">Prefer email?</h3>
