...
// Only the known industry slugs are valid; anything else 404s.
...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  const fullTitle = `${industry.metaTitle} — DailyBrew`;
  return {
...
export default async function IndustryPage({ params }: { params: Params }) {
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumbSchema([{ name: industry.label, path: `/${slug}` }])} />
